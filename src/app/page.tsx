      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {/* Hunter */}
            <div className="bg-black/50 border-green-500/30 p-6 rounded-lg hover:border-green-400/50 transition-all duration-300 cursor-pointer">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm mb-4">Master the void with precision and agility</p>
                <button className="w-full bg-green-600 hover:bg-green-500 text-black font-semibold py-3 px-6 rounded-lg transition-colors">
                  Select Hunter
                </button>
              </div>
            </div>
            ...
            <div className="bg-black/50 border-green-500/30 p-6 rounded-lg hover:border-green-400/50 transition-all duration-300 cursor-pointer">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm mb-4">Wield the cosmic power of the Light</p>
                <button className="w-full bg-green-600 hover:bg-green-500 text-black font-semibold py-3 px-6 rounded-lg transition-colors">
                  Select Warlock
                </button>
              </div>
            ...
            <div className="bg-black/50 border-green-500/30 p-6 rounded-lg hover:border-green-400/50 transition-all duration-300 cursor-pointer">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm mb-4">Unleash devastating strength and resilience</p>
                <button className="w-full bg-green-600 hover:bg-green-500 text-black font-semibold py-3 px-6 rounded-lg transition-colors">
                  Select Titan
                </button>
              </div>
        ...
        <div className="text-center mt-16 text-gray-400">
          <p>Powered by GPT-4o, Gemini AI & DeepSeek</p>
        </div>
      </div>
    </div>
  )
